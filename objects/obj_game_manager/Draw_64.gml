// Renders a noise texture across the entire screen that will randomly shift about in a 64 x 64 pixel area to simulate how old CRT static
// would look or how old film grain would appear.
var _noiseScale		= 1.0;
