// Before all structs are looped through and managed, the light management struct will remove any values that point to non-persistent light 
// sources. Persistent instances are skipped over.
