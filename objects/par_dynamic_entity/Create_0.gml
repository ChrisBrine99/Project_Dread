...
// Bits for flags that are exclusive to dynamic entities, but are shared between all of them. Bits not shown here are occupied if their 
// value is higher than the highest value bit defined here.
...
update_position = function(_xMove, _yMove, _delta){
	...
	// Once fractional movement values has been removed and stored, updating the position of the Entity or perform collision detection if 
	// the Entity is set to collide with general world colliders.
