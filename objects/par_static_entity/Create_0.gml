...
// Variables for the entity's custom animation implementation, which will utilize the sprite's speed set within the editor as well as a target
// animation frame rate of 60 fps to provide a frame-independent animation system.
animSpeed		= 0.0;
animFps			= 0.0;
animLength		= 0;
animLoopStart	= 0;
...
// Stores a reference to a light source struct that will be placed at a given offset relative to the Entity's current position. The offset on
// the x and y axes are stored in the two other values below.
lightSource		= noone;
lightX			= 0;
lightY			= 0;
