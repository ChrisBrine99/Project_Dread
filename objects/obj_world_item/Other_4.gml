...
// Only two values need to be updated: the item's remaining quantity, and its durability. Once grabbed, the 
// item will have its base values replaced with these stored values.
var _quantity	= 0;
var _durability	= 0;
with(_data){
	_quantity	= quantity;
