...
// The only value that is needed here is a value that ties it to a bit within the event flag buffer. When set, this flag will prevent the 
// expansion in question from spawning in again for the player to pick up.
